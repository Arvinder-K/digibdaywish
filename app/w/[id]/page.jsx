...
export default function WishPage({ params }) {
  ...
  if (loading) return <div style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}><h2>🌟 Loading Magic...</h2></div>;
  if (error) return <div style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}><h1>{error}</h1></div>;
      ...
      <AnimatePresence mode="wait">
        {!opened ? (
          ...
          >
            ...
            <button className="btn-primary" style={{ marginTop: '2rem', background: 'white', color: wish.theme_color, fontSize: '1.3rem', padding: '16px 32px' }}>
              Tap to Open!
            </button>
          </motion.div>
        ) : (
          ...
          >
            ...
            <div style={{ marginTop: '3rem', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1rem' }}>
              <button 
                ...
                style={{ background: 'white', color: wish.theme_color }}
                onClick={() => {
